...
public class LoginConstant {
    ...
    public static final List<String> GOOGLE_SCOPES = Arrays.asList("https://www.googleapis.com/auth/userinfo.profile", "https://www.googleapis.com/auth/userinfo.email");
}
